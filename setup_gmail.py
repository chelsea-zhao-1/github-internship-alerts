...
Usage:
  1. Download OAuth2 credentials from Google Cloud Console (Desktop app).
...
def main():
    ...
    print(f"  GMAIL_CREDENTIALS  ? contents of {CREDS_FILE}")
    print(f"  GMAIL_TOKEN        ? contents of {TOKEN_FILE}")
    print("  NOTIFY_EMAIL       ? your recipient email\n")
